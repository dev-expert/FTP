...
document.getElementById("iadd").innerHTML = person.add;
...
document.getElementById("lan1").innerHTML = skill.lan1;
document.getElementById("lan2").innerHTML = skill.lan2;

document.getElementById("int1").innerHTML = skill.int1;
document.getElementById("int2").innerHTML = skill.int2;
document.getElementById("int3").innerHTML = skill.int3;
