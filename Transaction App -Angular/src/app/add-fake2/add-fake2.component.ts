...
@Component({
  selector: 'app-add-fake2',
  templateUrl: './add-fake2.component.html',
  styleUrls: ['./add-fake2.component.css']
})
export class AddFake2Component implements OnInit {
  ...
  constructor(private modalService: NgbModal, private _datatable: DataService) {
