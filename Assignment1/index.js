...
function getUrl() {
    ...
    url.forEach(element => {
        ...
        str += `<li id="list">${element}<button type="button" onclick="deleteOnebyOne('${element}') "class="delete-btn">Delete</button>
                <input type="checkbox" id="chk" onclick="checkBox('${element}')"> </li> `
    });
