...
function login() {
    ...
    var bp1 = document.getElementById('edu14').value;
    var bp2 = document.getElementById('edu15').value;
    var bp3 = document.getElementById('edu24').value;
    var bp4 = document.getElementById('edu25').value;
    var bp5 = document.getElementById('edu34').value;
    var bp6 = document.getElementById('edu35').value;
    var bp7 = document.getElementById('git').value;
    var bp8 = document.getElementById('birth').value;
...
localStorage.setItem("qwe", JSON.stringify(arr));
    ...
    var obj1 = {
        name1: name1, email: user, phone: phn1,
        link: li
    };
    ...
    var lan = {
        lan1: lang1, lan2: lang2, lan3: lang3, lan4: lang4
